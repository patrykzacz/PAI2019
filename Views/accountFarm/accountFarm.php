...
<div class="container-fluid">
    ...
    <div class="row justify-content-center">
        ...
        <div class="col-lg-7 col-md-10 col-xs-12 account-edit">
            <form action="https://www.x-kom.pl/zmiana-danych-adresowych" method="post" class="form-horizontal highlight-errors address-form" id="addressForm" novalidate="novalidate">
                <h3>Dane adresowe</h3>
